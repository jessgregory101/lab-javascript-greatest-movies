...
function scoresAverage(moviesArray) {
    const scoresSum = moviesArray.reduce((accumulator, currentValue) => accumulator + currentValue.score, 0);
...
function dramaMoviesScore(moviesArray) {
    ...
    const scoresSum = dramaMovies.reduce((accumulator, currentValue) => accumulator + currentValue.score, 0);
    const averageScore = scoresSum / dramaMovies.length;
    return averageScore.toFixed(2);
};
